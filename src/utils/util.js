...
export function compareDate(sTime, eTime)
{
...
export function addHms(str, flag = 1)
{
  return str.substr(0, str.indexOf(' ')) + (flag ? ' 00:00:00' : ' 23:59:59');
}
...
export function editDateForSearch(obj)
{
  obj.startTime && (obj.startTime = moment(obj.startTime).format('YYYY-MM-DD') + ' 00:00:00')
  obj.endTime && (obj.endTime = moment(obj.endTime).format('YYYY-MM-DD') + ' 23:59:59')
